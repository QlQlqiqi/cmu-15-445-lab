...
class BPlusTreeInternalPage : public BPlusTreePage {
 public:
  ...
  // 找 key 应该属于的 child's index
  auto FindChildIndex(const ValueType &value) -> int;
  // 找 key 应该属于的 child
  auto FindChild(const KeyType &key, const KeyComparator &keyComparator) -> ValueType;
  // 将 kv 插入到最后一个
  ...
  void InsertL(const KeyType &key, const ValueType &value, const KeyComparator &keyComparator);
